...
const I18N = {
ko: {
  'nav.about':'조율 방식','nav.demo':'검증 사례','nav.projects':'확장 중','nav.process':'과정','nav.interview':'면접 순서','nav.portfolio':'직무 포트폴리오',
  ...
  'hero.badge':'면접용 자동화·효율화 증거 자료','hero.title':'자동화 사례를 영상과 원본 코드로 바로 설명합니다.','hero.lead':'인터뷰에서 요청받은 자동화·효율화 구축 사례를 노트북 화면으로 함께 볼 수 있도록 정리했습니다. 모든 데모는 더미 데이터 또는 마스킹된 흐름으로 구성했습니다.',
  ...
  'case.gift.note':'면접 설명 포인트: 흩어진 카톡/문자 접수를 표준 폼과 자동 알림 흐름으로 바꾼 방식.','case.sign.note':'면접 설명 포인트: PC 접근이 어려운 현장직 서명 수집을 모바일 입력, 해시, PDF 생성 흐름으로 바꾼 방식.','case.keyword.note':'면접 설명 포인트: 정성 인터뷰·설문 텍스트를 직무별 역량 키워드로 안정적으로 분류한 방식.','case.recruit.note':'면접 설명 포인트: 채용 정보를 포스터와 홍보 문구로 바꾸는 반복 작업을 생성 도구로 만든 방식.',
  ...
  'interview.eye':'면접 진행 순서','interview.title':'10분 안에 설명할 순서.','interview.lead':'자료 요청 의도에 맞춰 자동화 문제 정의, 설계 방식, 실제 동작, 성과를 빠르게 보여주는 흐름입니다.','interview.1.t':'문제부터 짚기','interview.1.d':'누락, 수기 반복, 현장 접근성, 문구 품질 편차처럼 업무 병목을 먼저 설명합니다.','interview.2.t':'설계 방식 설명','interview.2.d':'AI를 분석가, 구현자, 검증자로 나눠 어떤 판단은 사람이 고정했는지 보여줍니다.','interview.3.t':'영상으로 동작 확인','interview.3.d':'각 사례의 큰 데모 영상을 보며 입력, 처리, 출력, 기록 흐름을 따라갑니다.','interview.4.t':'성과와 보안 범위 정리','interview.4.d':'수치 성과는 설명하고, 공개 화면은 더미 데이터와 마스킹 흐름임을 명확히 합니다.',
...
en: {
  'nav.about':'Method','nav.demo':'Evidence','nav.projects':'Expanding','nav.process':'Process','nav.interview':'Interview Flow','nav.portfolio':'Career Portfolio',
  ...
  'hero.badge':'Interview evidence for automation and efficiency','hero.title':'Automation cases explained with demos and source code.','hero.lead':'This page is prepared for an interview discussion about automation and efficiency work. All demos use dummy data or masked flows.',
  ...
  'case.gift.note':'Interview point: how scattered chat/text requests became a standardized form and notification flow.','case.sign.note':'Interview point: how mobile input, hashing, and PDF generation solved field-worker signature collection.','case.keyword.note':'Interview point: how qualitative interview and survey text became stable role-based keyword groups.','case.recruit.note':'Interview point: how repetitive job-posting copy and poster work became a generation tool.',
  ...
  'interview.eye':'Interview flow','interview.title':'A 10-minute walkthrough.','interview.lead':'A compact flow for explaining problem framing, design method, working demo, and result within the interview slot.','interview.1.t':'Start with the bottleneck','interview.1.d':'Explain missed requests, manual repetition, field access, or copy-quality variance first.','interview.2.t':'Explain the design','interview.2.d':'Show how AI roles were split and which decisions stayed human-owned.','interview.3.t':'Watch the demo','interview.3.d':'Use the large videos to follow input, processing, output, and record flow.','interview.4.t':'Close with result and security','interview.4.d':'Explain measured outcomes and clarify dummy-data or masked-data boundaries.',
...
zh: {
  'nav.about':'编排方式','nav.demo':'验证案例','nav.projects':'扩展中','nav.process':'流程','nav.interview':'面试流程','nav.portfolio':'职业作品集',
  ...
  'hero.badge':'面试用自动化与效率化证据','hero.title':'用演示视频和源代码说明自动化案例。','hero.lead':'这个页面用于面试中说明自动化和效率化项目。所有演示均使用虚拟数据或脱敏流程。',
  ...
  'case.gift.note':'面试说明点：把分散的聊天/短信申请改为标准表单和自动通知流程。','case.sign.note':'面试说明点：用移动输入、哈希和PDF生成解决现场员工签名收集。','case.keyword.note':'面试说明点：把定性访谈和问卷文本稳定分类为职务关键词。','case.recruit.note':'面试说明点：把反复制作招聘文案和海报的工作改为生成工具。',
  ...
  'interview.eye':'面试流程','interview.title':'10分钟内说明的顺序。','interview.lead':'按照资料请求意图，快速展示自动化问题定义、设计方式、实际运行和成果。','interview.1.t':'先说明问题','interview.1.d':'先说明遗漏、手工重复、现场访问限制、文案质量偏差等业务瓶颈。','interview.2.t':'说明设计方式','interview.2.d':'展示如何把AI分为分析、实现、验证角色，以及哪些判断由人固定。','interview.3.t':'用视频确认运行','interview.3.d':'通过大尺寸演示视频查看输入、处理、输出和记录流程。','interview.4.t':'整理成果和安全范围','interview.4.d':'说明量化成果，并明确公开画面使用虚拟数据或脱敏流程。',
...
ja: {
  'nav.about':'調整方式','nav.demo':'検証事例','nav.projects':'拡張中','nav.process':'プロセス','nav.interview':'面接順序','nav.portfolio':'職務ポートフォリオ',
  ...
  'hero.badge':'面接用の自動化・効率化証拠資料','hero.title':'自動化事例を動画とソースコードで説明します。','hero.lead':'面接で自動化・効率化の構築事例を説明するためのページです。すべてのデモはダミーデータまたはマスキング済みの流れで構成しています。',
  ...
  'case.gift.note':'面接説明ポイント：分散したチャット・SMS受付を標準フォームと自動通知の流れに変えた方法。','case.sign.note':'面接説明ポイント：PC利用が難しい現場職の署名収集をモバイル入力、ハッシュ、PDF生成で解決した方法。','case.keyword.note':'面接説明ポイント：定性インタビューとアンケート文を職務別キーワードに安定分類した方法。','case.recruit.note':'面接説明ポイント：採用情報をポスターと広報文にする反復作業を生成ツールにした方法。',
  ...
  'interview.eye':'面接進行順序','interview.title':'10分以内で説明する順序。','interview.lead':'資料依頼の意図に合わせ、自動化の問題定義、設計方法、実動作、成果を素早く示す流れです。','interview.1.t':'問題から確認','interview.1.d':'漏れ、手作業の反復、現場アクセス、文言品質のばらつきなど業務ボトルネックを先に説明します。','interview.2.t':'設計方法を説明','interview.2.d':'AIを分析、実装、検証に分け、どの判断を人が固定したかを示します。','interview.3.t':'動画で動作確認','interview.3.d':'各事例の大きなデモ動画で入力、処理、出力、記録の流れを追います。','interview.4.t':'成果と安全範囲を整理','interview.4.d':'定量成果を説明し、公開画面はダミーデータまたはマスキング済みの流れであることを明確にします。',
